...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA4     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = ADC_Pin_Pin|ADC_VR_ESC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = JOY1_X_Pin|JOY1_Y_Pin|JOY2_X_Pin|JOY2_Y_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA4     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOC, ADC_Pin_Pin|ADC_VR_ESC_Pin);

    HAL_GPIO_DeInit(GPIOA, JOY1_X_Pin|JOY1_Y_Pin|JOY2_X_Pin|JOY2_Y_Pin);
